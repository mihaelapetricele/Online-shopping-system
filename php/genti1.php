...
$sql="SELECT pret,cale,descriere,promo from produse where tip='g'";
    $c=0;
            ...
            while($linie=mysqli_fetch_array($r))
            {
                ...
                if($linie[3])
                {
                    $p=$linie[0]-10;
                     if($c<=4)
                    {
                        echo"<td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b><s>$linie[0]</s> $p RON</b></font></center>";
                         ?><center>
                    ...
                    {
                        echo"</tr><tr><td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b><s>$linie[0]</s> $p RON</b></font></center>";
                         ?><center>
                            <form method="post" action="">
                        <br>
                         <input type="submit" name="but" id="cump"  value="Cumpără">
                ...
                else
                {
                    if($c<=4)
                    {
                        echo"<td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b>$linie[0] RON</b></font></center>";
                         ?><center>
                            <form method="post" action="">
                       <br>
                         <input type="submit" name="but" id="cump"  value="Cumpără">
                    ...
                    {
                        echo"</tr><tr><td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b>$linie[0] RON</b></font></center>";
                         ?><center>
                            <form method="post" action="">
                        <br>
                         <input type="submit" name="but" id="cump"  value="Cumpără">

...
<div id="mijloc1">
<div align="left">
    <img src="imagini/img4.jpg" height="330" width="270" >&nbsp&nbsp&nbsp&nbsp
    <div id="text1">
        <font size="6"><i><b>Colecția de <br>pantaloni</b></i></font>
    </div>
    <img src="imagini/img3.jpg" height="330" width="270">&nbsp&nbsp&nbsp&nbsp
    <div id="text2">
        <font size="6"><i><b>Colecția de <br>pantofi</b></i></font>
    </div>
    <img src="imagini/img2.jpg" height="330" width="270">&nbsp&nbsp&nbsp&nbsp
    <div id="text3">
        <font size="6"><i><b>Colecția de <br>rochii</b></i></font>
    </div>
    <img src="imagini/img10.jpg" height="330" width="270">
     <div id="text4">

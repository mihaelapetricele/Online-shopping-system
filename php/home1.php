...
<center> 
    <div id="log">
        <table>
          <form name="login" method="post" action="login.php"><br><br>
              <tr><td> NUME UTILIZATOR:</td><td><input type="text" name="username" size="10"></td></tr><br><br>
                PAROLA: <input type="password" name="password" size="10"><br><br>

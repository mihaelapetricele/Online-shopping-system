...
<div id="antet">
    <div align="right">
    <div id="cos">
            <img src="imagini/cos.gif" height="35" width="35">
    </div>
    <div>
        </div>
    </div>
...
$sql="SELECT pret,cale,descriere,promo from produse where tip='t'";
    $c=0;
            ...
            while($linie=mysqli_fetch_array($r))
            {
                ...
                if($linie[3])
                {
                    $p=$linie[0]-10;
                     if($c<=4)
                    {
                        echo"<td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b><s>$linie[0]</s> $p RON</b></font></center><br>";
                         ?><center>
                        ...
                        <select name="marime" id="marime">
                         ...
                         <input type="submit" name="but" id="cump"  value="Cumpără">
                         </form>
                            </center>
                        <?php
                     }
                    ...
                    {
                        echo"</tr><tr><td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b><s>$linie[0]</s> $p RON</b></font></center><br>";
                         ?><center>
                            <form method="post" action="">
                        <select name="marime" id="marime">
                            <option>XS</option>
                ...
                else
                {
                    if($c<=4)
                    {
                        echo"<td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b>$linie[0] RON</b></font></center><br>";
                         ?><center>
                            <form method="post" action="">
                        <select name="marime" id="marime">
                            <option>XS</option>
                    ...
                    {
                        echo"</tr><tr><td><img src=$linie[1] height=370px width=270px><br><br><center><i><font size=4>$linie[2]</i></font><br><br><font size=4><b>$linie[0] RON</b></font></center><br>";
                         ?><center>
                            <form method="post" action="">
                        <select name="marime" id="marime">
                            <option>XS</option>
